      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
          ...
          <div className="w-full md:w-1/2">
            <h3 className=" text-5xl font-serif mb-4 text-white cormorant-garamond-light uppercase  ">Our Craft</h3>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            <h3 className="text-5xl font-serif mb-4 md:pl-20  text-white cormorant-garamond-light uppercase  ">Custom Designs</h3>
